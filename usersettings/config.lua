Config = {
  ...
  TimeSystem = "qb-weathersync", --## vSync or cd_easytime or qb-weathersync
  --## INVENTORY SYSTEM
  Inventory         = "ox_inventory", --## "qb-inventory", "mf-inventory", "qs-inventory", "ox_inventory"
  ItemIconsDir      = "ox_inventory/web/images/", --## Directory for the icons you use for your inventory.
  --## TARGET
  TargetSystem = "ox_target", --## qb-target, qtarget, ox_target, dirk-prompts,
  --## FRAMEWORK OPTION
  UsingQBCore = true,
  UsingESX    = false,
